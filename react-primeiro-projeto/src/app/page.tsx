...
const Page = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center text-2xl">
      ...
      <div className="flex w-full max-w-lg my-3 p-3 rounded-md bg-gray-700 border-2 border-gray-50">
        <input
          type="text"
        ...
        />
        <button onClick={handleAddButton} className="bg-blue-700 rounded-md p-3">Adicionar</button>
      </div>
